...
export default function CorrectionsPanel({
  ...
  return (
    <div ref={panelRef} className="relative">
      ...
      {/* Popover Panel */}
      {isOpen && (
        <div className="absolute right-0 top-12 z-50 w-[380px] rounded-2xl border border-[var(--card-border)] bg-white shadow-xl shadow-slate-200/60 animate-scaleIn origin-top-right overflow-hidden">
          {/* Header */}
