...
export default function SmartUploadModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm animate-fadeIn" role="dialog" aria-modal="true" aria-label="Smart Upload">
      <div className="relative w-full max-w-[620px] overflow-hidden rounded-2xl border border-[var(--card-border)] shadow-2xl" style={{ background: "var(--card)" }}>
        {/* Header */}
        ...
        <div className="flex border-b border-[var(--card-border)]">
          <button
            ...
            style={activeTab === "image" ? { background: "var(--primary-light)" } : { color: "var(--muted)" }}
          >
            <svg
              width="16"
              height="16"
          ...
          <button
            ...
            style={activeTab === "document" ? { background: "var(--primary-light)" } : { color: "var(--muted)" }}
          >
            <svg
              width="16"
              height="16"
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              {!imageFile ? (
                <div
                  ...
                  className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed py-10 transition-colors hover:border-indigo-400"
                ...
                <div className="space-y-3">
                  <div className="overflow-hidden rounded-xl border border-[var(--card-border)]" style={{ background: "var(--subtle-bg)" }}>
                    {imagePreview && (
                      <img
                        src={imagePreview}
            ...
            <div className="space-y-4">
              ...
              {!docFile ? (
                <div
                  ...
                  className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed py-10 transition-colors hover:border-violet-400"
                  style={{ borderColor: "var(--card-border)", background: "var(--subtle-bg)" }}
                >
                ...
                <div className="rounded-xl border border-[var(--card-border)] px-5 py-4" style={{ background: "var(--subtle-bg)" }}>
                  <div className="flex items-center gap-3">
                    <div
          ...
          {/* Help Text */}
          <div className="mt-5 rounded-lg px-4 py-3" style={{ background: "var(--subtle-bg)" }}>
            ...
            {activeTab === "image" ? (
              <ul className="space-y-1 text-[11px]" style={{ color: "var(--muted)" }}>
